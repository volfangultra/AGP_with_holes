...
void __fastcall Tagp_aplication::ButtonTriangulationClick(TObject *Sender)
{
	ifstream inputFileCampus("C:/Users/nedim/Desktop/AGP_campus/AGP_with_holes/Builder_code/campus.txt");
